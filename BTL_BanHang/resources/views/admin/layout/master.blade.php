                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-secondary">
                                    <div class="menu-header-image opacity-5"
                                         style="background-image: url('../../../../../../../Tải xuống/CodeLean.vn Laravel Resources-20240521T072329Z-001/CodeLean.vn Laravel Resources/Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets//images/dropdown-header/abstract2.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('../../../../../../../Tải xuống/CodeLean.vn Laravel Resources-20240521T072329Z-001/CodeLean.vn Laravel Resources/Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets//images/dropdown-header/abstract3.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    <div class="menu-header-image"
                                         style="background-image: url('../../../../../../../Tải xuống/CodeLean.vn Laravel Resources-20240521T072329Z-001/CodeLean.vn Laravel Resources/Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets//images/dropdown-header/abstract4.jpg');">
                                    </div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true"
                            ...
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('../../../../../../../Tải xuống/CodeLean.vn Laravel Resources-20240521T072329Z-001/CodeLean.vn Laravel Resources/Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets//images/dropdown-header/city3.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05"
                                         style="background-image: url('../../../../../../../Tải xuống/CodeLean.vn Laravel Resources-20240521T072329Z-001/CodeLean.vn Laravel Resources/Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets//images/dropdown-header/city2.jpg');">
                                    </div>
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="front/img_logo/user/{{Auth::user()->avatar ?? 'default-avatar.jpg'}}"
                                             alt="">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="front/img_logo/user/{{Auth::user()->avatar ?? 'default-avatar.jpg'}}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                                                            ...
                                                            <div class="widget-content-right mr-2">
                                                                <a class="btn-pill btn-shadow btn-shine btn btn-focus" href="./admin/logout">Logout</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/order" class="{{(request()->segment(2) == 'order') ? 'mm-active' : ''}}"><i class="metismenu-icon"></i>Order
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/product" class="{{(request()->segment(2) == 'product') ? 'mm-active' : ''}}"><i class="metismenu-icon"></i>Product
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/category" class="{{(request()->segment(2) == 'category') ? 'mm-active' : ''}}"><i class="metismenu-icon"></i>Category
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/brand" class="{{(request()->segment(2) == 'brand') ? 'mm-active' : ''}}"><i class="metismenu-icon"></i>Brand
                                    </a>
                                </li>
                            </ul>
                        </li>
                                        ...
                                        <div class="d-none popover-custom-content">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                    <div class="menu-header-image opacity-1"
                                                         style="background-image: url('../../../../../../../Tải xuống/CodeLean.vn Laravel Resources-20240521T072329Z-001/CodeLean.vn Laravel Resources/Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets//images/dropdown-header/city5.jpg');">
                                                    </div>
                                                    <div class="menu-header-content text-dark">
